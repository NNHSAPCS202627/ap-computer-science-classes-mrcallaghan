...
public class Car
{
   ...
   */
   ...
   {
      // construct car components from simple shapes
      ...
      // draws the car using Graphics2D object (g2)
      //    
      g2.setColor(Color.RED);       // changes pen color of Graphics2D object
      g2.fill(body);                // fills in shape
      g2.setColor(Color.BLACK);
      g2.fill(frontTire);
      g2.fill(rearTire);
      g2.draw(frontWindshield);     // draws shape outline
      g2.draw(roofTop);      
